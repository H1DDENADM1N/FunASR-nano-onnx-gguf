...
def benchmark_old_model_dml():
    model_path = r'./model/Fun-ASR-Nano-Encoder-Adaptor.fp32.onnx'
    print(f"--- Profiling Old Model (DirectML, 60s) ---")
    ...
    feed = {input_name: np.random.randn(1, 1, 16000 * 60).astype(np.float32)}
